# py2md auto-project Technical Reference Guide
Generated by [py2md](https://github.com/gbowerman/py2md).

## Contents
1. [acs.py - azurerm functions for the Azure Container Service](#acs.py---azurerm-functions-for-the-Azure-Container-Service)
...
3. [amsrp.py - azurerm functions for the Microsoft.Media resource provider.](#amsrp.py---azurerm-functions-for-the-Microsoft.Media-resource-provider.)
4. [computerp.py - azurerm functions for the Microsoft.Compute resource provider](#computerp.py---azurerm-functions-for-the-Microsoft.Compute-resource-provider)
5. [ container.py - azurerm functions for Azure Container instances](#-container.py---azurerm-functions-for-Azure-Container-instances)
6. [deployments.py - azurerm functions for Deployments](#deployments.py---azurerm-functions-for-Deployments)
7. [insightsrp.py - azurerm functions for the Microsoft.Insights resource provider](#insightsrp.py---azurerm-functions-for-the-Microsoft.Insights-resource-provider)
8. [networkrp.py - azurerm functions for the Microsoft.Network resource provider](#networkrp.py---azurerm-functions-for-the-Microsoft.Network-resource-provider)
9. [resourcegroups.py - azurerm functions for Resource Groups.](#resourcegroups.py---azurerm-functions-for-Resource-Groups.)
10. [azurerm restfns - REST functions for azurerm](#azurerm-restfns---REST-functions-for-azurerm)
11. [settings.py - place to store constants for azurerm](#settings.py---place-to-store-constants-for-azurerm)
12. [storagerp.py - azurerm functions for the Microsoft.Storage resource provider](#storagerp.py---azurerm-functions-for-the-Microsoft.Storage-resource-provider)
...
14. [templates.py - azurerm functions for deploying templates](#templates.py---azurerm-functions-for-deploying-templates)
15. [vmimages.py - azurerm functions for Microsoft.Compute RP publishers and images](#vmimages.py---azurerm-functions-for-Microsoft.Compute-RP-publishers-and-images)
